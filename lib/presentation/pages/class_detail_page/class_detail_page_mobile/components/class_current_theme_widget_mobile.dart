...
import 'package:geo_app/presentation/pages/class_detail_page/class_detail_page_desktop/components/class_progress_widget.dart';

class ClassCurrentThemeWidgetMobile extends StatelessWidget {
  const ClassCurrentThemeWidgetMobile({super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          const ClassProgressWidgetDesktop(
